...
const values = [
  {
    ...
    description: 'We practice and teach the seven principles of Leave No Trace. Every trip includes education on minimizing our environmental impact.',
  },
  {
    icon: Users,
    title: 'Inclusive Community',
    description: 'Outdoors are for everyone. We welcome people of all backgrounds, skill levels, and abilities to join our adventures.',
  },
  {
    icon: Sparkles,
    title: 'Skill Building',
    description: 'From navigation to first aid, we offer workshops and hands-on learning opportunities to help you grow as an outdoor enthusiast.',
  },
  {
    icon: Shield,
    title: 'Safety First',
    description: 'All our trip leaders are trained in wilderness safety. We maintain strict protocols and never compromise on safety.',
  },
]
...
const activities = [
  ...
  },
  {
    ...
    description: 'Snowshoeing, backcountry skiing, and winter camping expeditions.',
    image: 'https://images.unsplash.com/photo-1491002052546-bf38f186af56?w=600&h=400&fit=crop',
  },
  {
    title: 'Workshops',
...
const steps = [
  {
    number: '01',
    title: 'Join the Club',
    description: 'Become a member for just $25/year to unlock access to all trips and the member community.',
  },
  {
    number: '02',
    title: 'RSVP to Trips',
    ...
    <div className="min-h-screen flex flex-col bg-background">
      <main className="flex-1 pt-16">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  ...
                  <p>
                    Every trail we walk, every peak we summit, and every campfire we gather around strengthens our bond with nature and each other.
                  </p>
                </div>
              </div>
        ...
        <section className="py-24 px-4 bg-secondary/30">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <span className="text-primary font-medium text-sm uppercase tracking-wider">Activities</span>
              <h2 className="text-3xl md:text-4xl font-bold mt-2 mb-4 text-balance">
                What We Do
              </h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                From casual day hikes to technical alpine climbs, we offer a wide range of outdoor experiences for every skill level.
              </p>
            </div>
        ...
        <section className="py-24 px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <span className="text-primary font-medium text-sm uppercase tracking-wider">Our Principles</span>
              <h2 className="text-3xl md:text-4xl font-bold mt-2 mb-4 text-balance">
                Our Values
              </h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                These core values guide everything we do, from planning trips to welcoming new members.
              </p>
            </div>

            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {values.map((value) => (
                <Card key={value.title} className="p-6 bg-card border-border/50 hover:border-primary/20 transition-colors">
        ...
        <section className="py-24 px-4 bg-secondary/30">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Joining Mountain Club is simple. Here is how to get started on your next adventure.
              </p>
            </div>
