...
- The owner saved Resend SMTP and Google/Discord credentials directly in the preview dashboard and added `https://qarabfhyyekjqmzsuhzo.supabase.co/auth/v1/callback` to both provider apps. Google was initially still disabled; enabled it after confirming its credentials were present. Both authorize endpoints now redirect to their respective providers with this exact callback. Successful provider login/linking still requires human acceptance; a redirect alone is not proof of success.
