...
Trip registration has a separate release gate: [RSVP runbook](RSVP_RUNBOOK.md). It ships disabled until waiver content, guardian review, notification delivery, and a controlled pilot are verified.
