      ...
      <details className="rounded-lg border p-4">
        ...
        >
          ...
          <ToggleField
            ...
            onChange={collectTransportation =>
              update({ collectTransportation })
            }
          />
          <div className="space-y-2">
          ...
          <fieldset disabled={locked} className="space-y-4">
            ...
            {snapshot.annualWaiver ? (
              <p className="text-sm">
                Covered trips use the current published annual UNLV waiver.
                Annual content is managed in Registration operations. Activities
                outside its scope require officer review before participation.
              </p>
            ) : (
              <>
                ...
                <Input
                  ...
                  onChange={event =>
                    update({ waiverTitle: event.target.value })
                  }
                />
                <Label htmlFor="waiver-body">
                  Club-approved waiver text (leave empty to keep current
                  version)
                </Label>
                <Textarea
                  id="waiver-body"
