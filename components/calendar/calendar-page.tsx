...
export function CalendarPage({ trips, teasers, membershipState, currentMonth }: CalendarPageProps) {
  ...
  const isMember = !!membershipState.membershipId
            ...
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
                  ...
                  <CalendarActions membershipState={membershipState} />
                </div>
