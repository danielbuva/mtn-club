...
export function ChaptersDrawer({ sections }: ChaptersDrawerProps) {
  ...
  const isSectionId = useCallback(
    (id: string): id is Section['id'] => ids.includes(id as Section['id']),
    [ids],
  )
  ...
  return (
    <>
      ...
      {open ? (
        ...
        >
          <button
            ...
            className="absolute inset-0 border-0 bg-black/20 p-0"
      ...
      <div className="pointer-events-none fixed bottom-4 left-1/2 z-40 -translate-x-1/2 text-xs uppercase tracking-widest text-muted-foreground">
