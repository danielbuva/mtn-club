...
interface TravelPreferencesProps {
  value: TravelProfile
  onChange: <K extends keyof TravelProfile>(key: K, value: TravelProfile[K]) => void
}

export function TravelPreferencesSection({ value, onChange }: TravelPreferencesProps) {
  return (
    <ProfileSection
    ...
    >
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-muted-foreground">Let others know if you can carpool.</p>
        </div>
        <Switch
      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-muted-foreground">Opt in for carpool coordination.</p>
        </div>
        <Switch
