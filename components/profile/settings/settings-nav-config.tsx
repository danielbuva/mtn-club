...
export const settingsNavSections: SettingsNavSection[] = [
  {
    ...
    items: [
      {
        label: 'Account',
        href: '/profile/user/account',
        description: 'Name, email, security',
      },
      {
        label: 'Data & Privacy',
        href: '/profile/user/privacy',
        description: 'Visibility and sharing',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      {
        label: 'Gear',
        href: '/profile/preferences/gear',
        description: 'What you have and need',
      },
      {
        label: 'Skills',
        href: '/profile/preferences/skills',
        description: 'Certifications',
      },
      {
        label: 'Interests',
        href: '/profile/preferences/interests',
        description: 'Trips you enjoy',
      },
      {
        label: 'Theme',
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: 'Travel prefs',
        href: '/profile/events/travel-prefs',
        description: 'Carpool details',
      },
    ],
  },
]
